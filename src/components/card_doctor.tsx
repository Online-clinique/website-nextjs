...
function CardDoctor({ doctor }: { doctor: IDoctor }) {
	return (
		<div>
			<div className="w-full flex items-center flex-wrap mx-auto my-32 lg:my-0">
				{/*Main Col*/}
				<div
					id="profile"
				...
				>
					<div className="p-4 md:p-12 text-center lg:text-left">
						...
						<p className="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
							...
							Localisation:{' '}
							{doctor.ville + ' ' + (doctor.adresse_cabinet || '')}
						</p>
						<p className="pt-8 text-sm">{doctor.about}</p>
				...
				<div className="w-full lg:w-2/5">
					...
					<img
						...
						className="max-w-xs rounded-lg my-5"
					/>
