...
function DoctorProfile() {
	const [selectedSpec, setSelectedSpecialit] = React.useState<{ value: string; label: string }[]>([]);
							...
							<div className="p-9">
										...
										<form action="#" method="POST">
											<div className="shadow sm:rounded-md sm:overflow-hidden">
												<div className="px-4 py-5 bg-white space-y-6 sm:p-6">
													<div>
														<label htmlFor="about" className="block text-md font-medium text-gray-700 underline bold">
															A props de vous
                    									</label>
														<div className="mt-1">
															<textarea id="about" name="about" rows={3} className="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 mt-1 block w-full sm:text-sm border p-1 border-gray-300 rounded-md" placeholder="Je suis un docteur generaliste diplomé de paris" defaultValue={""} />
														</div>
								...
								<div className="mt-10 sm:mt-0">
									<div className="md:grid md:grid-cols-3 md:gap-6">
										<div className="md:col-span-1">
											<div className="px-4 sm:px-0">
												<h3 className="text-lg font-medium leading-6 text-gray-900">Choix des jours férié</h3>
												<p className="mt-1 text-sm text-gray-600">
											...
											<form action="#" method="POST">
												<div className="shadow sm:rounded-md">
													<Select
														...
														value={selectedSpec}
														onChange={(selected) => {
															console.log(selectedSpec.map(val => val.value).join(','));
													...
													{/* {
														selectedSpec.length > 0 ? (
															<div className="min-w-full p-9">
																{
																	selectedSpec.map(selected => {
																		return (
																			<div className="w-full">
																				<p className="text-center mx-auto p-2 m-4 border border-1 rounded-md bg-cyan-300 text-gray-800 font-bold">{selected.label}</p>
																				<div className="flex flex-wrap justify-between">
																					<h1 className="text-lg font-semibold p-2">Début journé</h1>
																					<h1 className="text-lg font-semibold p-2">Fin journé</h1>
																				</div>
																				<div className="flex">
																					<div className="w-1/2">
																						<TimePicker
															...
															<div className="mt-4 space-y-4">
																<div className="flex items-start">
																	...
																	<div className="ml-3 text-sm">
																		<label htmlFor="comments" className="font-medium text-gray-700">Demande De rendez-vous</label>
																		<p className="text-gray-500">Etre notifier quand un patient demande un rendez vous.</p>
																	</div>
																</div>
																<div className="flex items-start">
																	<div className="flex items-center h-5">
																	...
																	<div className="ml-3 text-sm">
																		<label htmlFor="candidates" className="font-medium text-gray-700">Rendez-vous Ratté</label>
																		<p className="text-gray-500">Etres notifier quand un patient a ratté un rendez-vous</p>
																	</div>
																</div>
																{/* <div className="flex items-start">
																	<div className="flex items-center h-5">
